  ...
  return (
    <div className="flex md:flex-row md:py-0 py-[6rem] flex-col md:gap-0 gap-10  justify-between items-center md:pt-[6rem] md:px-[6rem] px-6">
      <div className='md:w-[35%] space-y-6'>
        <h1 className={`${font.className} text-3xl font-light`}>What Goes In Your<br/> Monhtly Subscribtion?</h1>
      ...
      <div className='text-md md:text-lg md:w-[35%] flex flex-col gap-6 items-start '>
