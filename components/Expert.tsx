...
const Expert = () => {
  return (
    <div className="flex flex-col gap-6 items-center justify-center w-full md:px-[6rem] px-6 pt-[6rem]">
      ...
      >
        Meet the hearts and souls of P-Nut. Their combined experience in
        nutrition science, Vedic wisdom, and Ayurveda is XXXXX years.
      </p>
          ...
          <div className="flex flex-col md:gap-[4rem] gap-6 md:w-[50%]">
            ...
            <div className="space-y-8">
              <p className="md:text-md md:w-[70%] text-sm leading-loose">
                ...
                constitution, genetics, and medical history. Dividing food
                requirements into macronutrients like carbs, fats, and proteins,
                or into micronutrients, is not exhaustive.
              </p>
              <p className="md:text-md md:w-[70%] text-sm leading-loose">
