...
useEffect(() => {
    ...
    return (
    <div className='flex flex-col gap-6 md:items-start items-center md:text-start text-center justify-start md:pt-0 pt-[6rem] md:w-[50%] md:h-[80vh] md:px-[4rem] px-6'>
